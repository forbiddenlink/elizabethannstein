  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        id: 'storyvision',
        title: 'StoryVision',
        description: 'Cinematic AI storytelling platform that transforms books (PDF, EPUB, TXT) into immersive visual experiences using Claude AI for intelligent scene extraction and Flux.1-dev for neural image generation.',
        role: 'Creator',
        tags: ['Next.js', 'TypeScript', 'Claude AI', 'Hugging Face', 'Prisma', 'Tailwind CSS'],
        color: '#00D9FF',
        brightness: 1.9,
        size: 'large',
        galaxy: 'ai',
        links: { live: 'https://storyvision.vercel.app', github: 'https://github.com/forbiddenlink/storyvision' },
        featured: true,
        dateRange: '2025',
        ...
        solution: 'Built Director Memory system (Character Bible + Style Bible) for visual continuity. Claude AI extracts cinematic scenes while Flux.1-dev generates consistent imagery.',
        impact: 'Transforms entire books into visual stories with consistent character design. Dark Void aesthetic creates immersive reading experience. Persistent gallery preserves generated art.',
      },
      {
        id: 'hireready',
        title: 'HireReady',
        description: 'Intelligent interview preparation platform with multi-format questions (MCQ, coding challenges), browser-based code execution, and FSRS spaced repetition for 90% retention.',
        role: 'Creator',
        tags: ['Next.js', 'TypeScript', 'Supabase', 'Monaco Editor', 'Stripe', 'PostHog'],
        color: '#00D9FF',
        brightness: 1.6,
        size: 'large',
        galaxy: 'ai',
        links: { live: 'https://hire-ready.vercel.app', github: 'https://github.com/forbiddenlink/hire-ready' },
        featured: true,
        dateRange: '2025',
        challenge: 'Interview prep tools lack scientifically-backed learning methods and real coding environments for practicing technical questions.',
        solution: 'Integrated FSRS spaced repetition algorithm for optimal retention, Monaco Editor for browser-based code execution, and multi-format questions across DSA, System Design, and Behavioral.',
        impact: '90% retention target through spaced repetition. 59+ questions with live code execution. Premium subscription tiers via Stripe.',
      },
    ],
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        size: 'large',
        galaxy: 'fullstack',
        links: { github: 'https://github.com/forbiddenlink/WillWise' },
        featured: false,
        dateRange: '2025',
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        id: 'dareuradio',
        title: 'DAREU Radio',
        description: 'Digital-first online radio platform featuring live streaming, Sanity CMS content management, and immersive soul/R&B music discovery with 2,196+ music history entries.',
        role: 'Creator',
        tags: ['Next.js', 'TypeScript', 'Sanity', 'Framer Motion', 'MDX', 'Tailwind CSS'],
        color: '#FF006E',
        brightness: 1.6,
        size: 'large',
        galaxy: 'design',
        links: { live: 'https://dareuradio.vercel.app', github: 'https://github.com/forbiddenlink/dareuradio' },
        featured: true,
        dateRange: '2025',
        challenge: 'Traditional radio platforms lack modern digital engagement features and struggle to connect music with cultural context and history.',
        solution: 'Built live Radio.co streaming with persistent audio player, Sanity CMS for 7 content types, and "On This Day" music history feature with 2,196+ entries.',
        impact: 'Persistent audio player continues across navigation. Full CMS enables non-technical content updates. Music history deepens listener engagement.',
      },
    ],
  },
  {
