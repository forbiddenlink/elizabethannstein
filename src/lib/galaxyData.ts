  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        id: 'contradictme',
        title: 'ContradictMe',
        description: 'Intelligent counterargument generator fighting echo chambers using Algolia Agent Studio and GPT-4. Presents strongest opposing viewpoints with advanced search ranking and AI debate arena. 73 passing tests.',
        role: 'Creator',
        ...
        solution: 'Integrated Algolia Agent Studio with GPT-4 for intelligent argument retrieval and ranking. Built credibility scoring, source verification, AI debate arena, and analytics dashboard.',
        impact: '73 automated tests ensure argument quality. Algolia-powered search delivers sub-100ms counterargument retrieval. Users report 3x more exposure to diverse perspectives.',
      },
      {
        id: 'interview-ace',
        title: 'Interview Ace',
