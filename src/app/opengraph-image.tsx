      ...
      >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            ...
            <div
              style={{
                ...
                height: '56px',
                borderRadius: '14px',
                background: 'linear-gradient(135deg, #030014, #0f0b29)',
            ...
            <span
              style={{ color: 'white', fontSize: '32px', fontWeight: 600, letterSpacing: '4px' }}
            >
              V.2.0.4
            </span>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1 }}>
            ...
            <span
              style={{
                fontSize: '130px',
                fontWeight: 800,
                backgroundImage: 'linear-gradient(135deg, #a855f7, #06b6d4, #f8fafc)',
                backgroundClip: 'text',
                color: 'transparent',
                letterSpacing: '-0.04em',
                paddingBottom: '20px',
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <span
              style={{ color: 'rgba(255,255,255,0.4)', fontFamily: 'monospace', fontSize: '22px' }}
            >
