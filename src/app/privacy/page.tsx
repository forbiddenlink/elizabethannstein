  ...
  return (
    <main className="min-h-screen bg-black text-white relative">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 animate-in slide-in-from-top-4 duration-500">
        <div className="mx-auto px-6 py-4 flex items-center justify-between backdrop-blur-md bg-black/40 border-b border-white/[var(--border-opacity-default)]">
          <Link
            href="/"
      ...
      <div id="privacy-content" className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150 fill-mode-both">
            <section className="bg-surface-2 p-8 rounded-2xl border border-white/[var(--border-opacity-default)] backdrop-blur-sm">
              <h2 className="text-2xl font-semibold mb-4">Overview</h2>
              <p className="text-white/[var(--text-opacity-primary)] leading-relaxed">
            ...
            <section className="bg-surface-2 p-8 rounded-2xl border border-white/[var(--border-opacity-default)] backdrop-blur-sm">
              ...
              <div className="space-y-4 text-white/[var(--text-opacity-primary)] leading-relaxed">
                <p>
