...
export default function HomePage() {
  ...
  return (
    <main className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <FadeIn delay={0.5} direction="up" className={`absolute bottom-4 left-4 right-4 md:bottom-10 md:left-10 lg:left-[240px] md:right-auto z-50 flex flex-col md:flex-row flex-wrap gap-3 md:gap-4 items-stretch md:items-center transition-opacity duration-500 ${isJourneyMode ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
        <Link
          href="/work"
