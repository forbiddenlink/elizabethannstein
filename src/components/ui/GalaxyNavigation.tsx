        ...
        >
          ...
          <nav className="flex flex-col gap-1.5 relative z-10">
            ...
            <div className="relative">
              ...
              {/* Tour Options Menu */}
              {showTourMenu && (
                <div className="absolute left-full bottom-0 ml-2 w-64 space-y-1 animate-fade-in max-h-[60vh] overflow-y-auto overflow-x-hidden bg-black/80 backdrop-blur-xl rounded-xl p-2 border border-white/10 shadow-2xl" style={{ scrollbarWidth: 'thin', scrollbarColor: 'rgba(255,255,255,0.2) transparent' }}>
                  {/* Default Galaxy Tour */}
                  <button
                    onClick={() => {
                      startJourney()
