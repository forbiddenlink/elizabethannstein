...
export function ResumeDownload() {
  ...
  return (
    <a
      ...
      className="fixed top-4 right-4 md:top-6 md:right-6 z-20 group flex items-center gap-2 md:gap-3 bg-white/15 backdrop-blur-xl border border-white/30 hover:bg-white/25 hover:border-white/40 rounded-xl transition-all duration-300 hover:scale-105 shadow-2xl px-4 py-3 md:px-8 md:py-5"
    >
