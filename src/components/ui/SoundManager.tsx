...
export function SoundManager() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 left-56 z-30 p-3 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 hover:border-white/30 transition-all duration-300 group hover:scale-110 hidden lg:flex"
